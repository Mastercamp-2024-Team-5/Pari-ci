  ...
  return (
    <ChakraProvider>
      <Container margin={0} padding={0} display="flex" justifyContent="space-between" maxW="100vw" h="100vh" bg="gray.100">
        {
          accessibleScreen ? (
            <Flex margin={0} padding={0} flex={1} direction={screenWidth<600?"column":'row'}>
              <Container flex="1" bg="F6FBF9" maxW={screenWidth<600?"100vw":"33vw"} maxH={screenWidth<600?"55vh":"100vh"}>
                <LeftSearch />
              </Container>
              <Container flex="1" bg="red.400" maxW={screenWidth<600?"100vw":"67vw"} maxH={screenWidth<600?"45vh":"100vh"} margin={0} padding={0}>
                <MapScreen />
              </Container>
            </Flex>
          ):(
